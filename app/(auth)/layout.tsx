...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
    ...
    const quote = isLogin
        ? "Your land is your best asset. Make sure it performs like one."
        : "Every great harvest starts with a single decision. This is yours.";
            ...
            <div className="hidden lg:flex w-1/2 relative">
                ...
                <div className="absolute bottom-12 left-12 right-12 z-10">
                    <div className="flex items-center gap-3 mb-8">
                        ...
                        <span className="font-heading italic text-white text-xl">FieldMind</span>
                    </div>
                    ...
                    <BlurText
                        ...
                        wordDelay={0.15}
                    />
                    <p className="text-white/40 text-xs font-body font-light mt-4">— FieldMind AI</p>

                    <div className="flex flex-wrap items-center gap-3 mt-8">
                        {["★ 2M+ acres monitored", "⚡ 24-hr first field report", "✓ 94% yield accuracy"].map((pill) => (
                            <span key={pill} className="liquid-glass rounded-full px-4 py-2 flex items-center gap-2 text-xs font-body text-white/70">
                                {pill}
                            </span>
                        ))}
                    </div>
